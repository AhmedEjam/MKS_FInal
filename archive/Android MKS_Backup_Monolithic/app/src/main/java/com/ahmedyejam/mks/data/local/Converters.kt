...
class Converters {
    ...
    fun toStringList(value: String?): List<String> {
        ...
        return try {
            ...
            MksLogger.w("Converters", "Failed to parse string list: $value", e)
            emptyList()
        }
    }
    ...
    fun toIntList(value: String?): List<Int> {
        ...
        return try {
            ...
            MksLogger.w("Converters", "Failed to parse int list: $value", e)
            emptyList()
        }
    }
    ...
    fun toLongList(value: String?): List<Long> {
        ...
        return try {
            ...
            MksLogger.w("Converters", "Failed to parse long list: $value", e)
            emptyList()
        }
    }
    ...
    fun toAnswersMap(value: String?): Map<Long, List<Int>> {
        ...
        return try {
            ...
            MksLogger.w("Converters", "Failed to parse answers map: $value", e)
            emptyMap()
        }
    }
    ...
    fun toNotesMap(value: String?): Map<Long, String> {
        ...
        return try {
            ...
            MksLogger.w("Converters", "Failed to parse notes map: $value", e)
            emptyMap()
        }
    }
    ...
    fun toIntMap(value: String?): Map<Long, Int> {
        ...
        return try {
            ...
            MksLogger.w("Converters", "Failed to parse int map: $value", e)
            emptyMap()
        }
    }
    ...
    fun toIntIntMap(value: String?): Map<Int, Int> {
        ...
        return try {
            ...
            MksLogger.w("Converters", "Failed to parse int-int map: $value", e)
            emptyMap()
        }
    }
    ...
    fun toIntListIntMap(value: String?): Map<Int, List<Int>> {
        ...
        return try {
            ...
            MksLogger.w("Converters", "Failed to parse int-list-int map: $value", e)
            emptyMap()
        }
    }
    ...
    fun toStringMap(value: String?): Map<String, Boolean> {
        ...
        return try {
            ...
            MksLogger.w("Converters", "Failed to parse string map: $value", e)
            emptyMap()
        }
    }
