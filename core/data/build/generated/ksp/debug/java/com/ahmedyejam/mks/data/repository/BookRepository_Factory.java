...
public final class BookRepository_Factory implements Factory<BookRepository> {
  ...
  private BookRepository_Factory(Provider<WorkspaceDao> workspaceDaoProvider,
  ...
  public static BookRepository_Factory create(Provider<WorkspaceDao> workspaceDaoProvider,
      ...
      Provider<AssetReferenceAuditService> assetReferenceAuditServiceProvider,
      Provider<CoroutineScope> scopeProvider) {
    return new BookRepository_Factory(workspaceDaoProvider, bookDaoProvider, quizDaoProvider, questionDaoProvider, sessionDaoProvider, categoryMetadataDaoProvider, fileManagerProvider, exportManagerProvider, importManagerProvider, flashcardDeckDaoProvider, flashcardDaoProvider, learningSessionDaoProvider, slideshowCourseDaoProvider, courseSlideDaoProvider, noteCollectionDaoProvider, noteBlueprintDaoProvider, promptDaoProvider, studySessionDaoProvider, knowledgeStudySessionDaoProvider, questionCategoryDaoProvider, assetReferenceDaoProvider, questionAssetDaoProvider, sourceDocumentDaoProvider, promptDeckDaoProvider, promptCardDaoProvider, promptRunDaoProvider, mistakeLogDaoProvider, quizRepositoryProvider, assetRepositoryProvider, annotationDaoProvider, deletePreviewServiceProvider, categoryMergePreviewServiceProvider, clearMarksPreviewServiceProvider, assetReferenceAuditServiceProvider, scopeProvider);
  }

  public static BookRepository newInstance(WorkspaceDao workspaceDao, BookDao bookDao,
      ...
      MistakeLogDao mistakeLogDao, javax.inject.Provider<QuizRepository> quizRepositoryProvider,
      javax.inject.Provider<AssetRepository> assetRepositoryProvider, AnnotationDao annotationDao,
      ...
      AssetReferenceAuditService assetReferenceAuditService, CoroutineScope scope) {
    return new BookRepository(workspaceDao, bookDao, quizDao, questionDao, sessionDao, categoryMetadataDao, fileManager, exportManager, importManager, flashcardDeckDao, flashcardDao, learningSessionDao, slideshowCourseDao, courseSlideDao, noteCollectionDao, noteBlueprintDao, promptDao, studySessionDao, knowledgeStudySessionDao, questionCategoryDao, assetReferenceDao, questionAssetDao, sourceDocumentDao, promptDeckDao, promptCardDao, promptRunDao, mistakeLogDao, quizRepositoryProvider, assetRepositoryProvider, annotationDao, deletePreviewService, categoryMergePreviewService, clearMarksPreviewService, assetReferenceAuditService, scope);
  }
}
