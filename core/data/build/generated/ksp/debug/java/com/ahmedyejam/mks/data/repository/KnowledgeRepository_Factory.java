...
public final class KnowledgeRepository_Factory implements Factory<KnowledgeRepository> {
  ...
  private KnowledgeRepository_Factory(Provider<WorkspaceDao> workspaceDaoProvider,
  ...
  public static KnowledgeRepository_Factory create(Provider<WorkspaceDao> workspaceDaoProvider,
      ...
      Provider<ClearMarksPreviewService> clearMarksPreviewServiceProvider,
      Provider<AssetReferenceAuditService> assetReferenceAuditServiceProvider) {
    return new KnowledgeRepository_Factory(workspaceDaoProvider, bookDaoProvider, quizDaoProvider, questionDaoProvider, sessionDaoProvider, categoryMetadataDaoProvider, fileManagerProvider, exportManagerProvider, importManagerProvider, flashcardDeckDaoProvider, flashcardDaoProvider, learningSessionDaoProvider, slideshowCourseDaoProvider, courseSlideDaoProvider, noteCollectionDaoProvider, noteBlueprintDaoProvider, promptDaoProvider, studySessionDaoProvider, knowledgeStudySessionDaoProvider, questionCategoryDaoProvider, assetReferenceDaoProvider, questionAssetDaoProvider, sourceDocumentDaoProvider, promptDeckDaoProvider, promptCardDaoProvider, promptRunDaoProvider, mistakeLogDaoProvider, quizRepositoryProvider, bookRepositoryProvider, assetRepositoryProvider, annotationDaoProvider, deletePreviewServiceProvider, categoryMergePreviewServiceProvider, clearMarksPreviewServiceProvider, assetReferenceAuditServiceProvider);
  }

  public static KnowledgeRepository newInstance(WorkspaceDao workspaceDao, BookDao bookDao,
    ...
    return new KnowledgeRepository(workspaceDao, bookDao, quizDao, questionDao, sessionDao, categoryMetadataDao, fileManager, exportManager, importManager, flashcardDeckDao, flashcardDao, learningSessionDao, slideshowCourseDao, courseSlideDao, noteCollectionDao, noteBlueprintDao, promptDao, studySessionDao, knowledgeStudySessionDao, questionCategoryDao, assetReferenceDao, questionAssetDao, sourceDocumentDao, promptDeckDao, promptCardDao, promptRunDao, mistakeLogDao, quizRepositoryProvider, bookRepositoryProvider, assetRepositoryProvider, annotationDao, deletePreviewService, categoryMergePreviewService, clearMarksPreviewService, assetReferenceAuditService);
  }
}
