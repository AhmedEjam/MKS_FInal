...
@Singleton
class MksDatabaseSeeder @Inject constructor(
    ...
    suspend fun seedDatabase(workspaceId: Long) {
        ...
        // --- English Quiz ---
        val englishQuizId = quizRepository.insertQuiz(
            QuizEntity(
        ...
        // --- Arabic Quiz ---
        val arabicQuizId = quizRepository.insertQuiz(
            QuizEntity(
        ...
        val howToStartEnId = quizRepository.insertQuiz(
            QuizEntity(
        ...
        val howToStartArId = quizRepository.insertQuiz(
            QuizEntity(
