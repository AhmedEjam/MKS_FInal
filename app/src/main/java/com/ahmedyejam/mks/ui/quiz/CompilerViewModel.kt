...
import com.ahmedyejam.mks.data.import.model.ParseStats
...
import com.ahmedyejam.mks.data.import.xlsx.SheetImageResolution
...
class CompilerViewModel(
    ...
    private val csvParser = com.ahmedyejam.mks.data.import.parser.CsvParser()
